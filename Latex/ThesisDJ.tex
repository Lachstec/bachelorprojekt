...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Einleitung}
Die Bedeutung von Software nimmt im Alltag moderner Unternehmen immer mehr an Bedeutung zu.
Insbesondere zur Realisierung von internen Geschäftsprozessen ist eine Eigenentwicklung von Software, die auf die Bedürfnisse von Unternehmen 
zugeschnitten ist, sinnvoll. Auch die Hessische Zentrale für Datenverarbeitung (HZD) setzt auf die Eigenentwicklung von Software in mehreren Bereichen.
Ein maßgeblicher Erfolgsfaktor zur erfolgreichen Anwendungsentwicklung ist die Möglichkeit, effizient mit Kolleginnen und Kollegen in Projekten kommunizieren.
Aktuell setzt die HZD auf eine Mischung aus E-Mails und der Messenging-Lösung Skype for Business, um in Projekten miteinander zu kommunizieren.
Diese Lösung stellte sich jedoch zunehmend als unübersichtlich heraus. Daher soll eine neue Anwendung beschafft werden, um die Abläufe in Projekten ergonomischer und
effizienter zu gestalten. Das im folgenden Text untersuchte Projekt hat zum Ziel, eine solche Anwendung aus einem Pool an möglichen Kandidaten auszuwählen und 
als einen Proof-of-Concept zu beschaffen. Durch das Umfeld eines großen Unternehmens im Bereich des öffentlichen Dienstes entstehen Besonderheiten und spezielle Anforderungen im Bereich
des Projektmanagements, welche im Rahmen dieser Arbeit näher betrachtet werden. 
...
Fälligkeitsterminen entschieden. 
