...
\section{Planungsphase (NW)}
\subfile{projektplanung.tex}

\section{Projektdurchführung und Controlling (NW)}
\subfile{projektcontrolling.tex}

\section{Wechsel der Kollaborationsplatform (NW)}
...
\section{Anforderungserweiterung: Barrierefreie Software (JD)}
\subfile{barrierefreiheit.tex}

\section{Projektabschluss (JD)}
