...
\begin{document}
  ...
  \begin{figure}[h!]
    ...
    \centering
    \caption{Schematische Darstellung des Vorgehensmodells. Entnommen aus \cite[S.~319]{dechange_projektmanagement_2024} (LL)}
    \label{fig:model}
  \end{figure}
	
  \subsection{Ausgangslage (LL)}
  ...
  \subsection{Projektbewertung (LL)}
  ...
  \begin{table}
    \begin{tabular}{|p{4cm}|p{4cm}|p{4cm}|p{4cm}|}
      ...
      \hline
    \end{tabular}
    \caption{Vergleich der Vorgehensmodelle (LL)}
    \label{tab:methods}
  \end{table}
  ...
  \subsection{Wahl der Organisationsstruktur (JD)}

\begin{figure}[ht]
    \hspace{-0.5cm}
    \includegraphics[width=40pc]{./Organisationsstrukturen.png}
    \caption{Typen einer Organisationsstruktur. Entnommen aus\cite[S.~75]{PMI2017PMBOK} (JD)}
    \label{fig:orgstrukturen}
\end{figure} 

\subsubsection{Beschreibung der Strukturen (JD)}
...
\subsubsection{Auswahl der passenden Struktur fürs Projekt (JD)}
...
Somit ist die für das Projekt am besten geeignete Organisationsstruktur eine organische bzw. simple Struktur.
  ...
  \subsection{Stakeholderanalyse (JD)}
  ...
  \newpage
  \subsection{Stakeholder (NW)}
    \begin{figure}[h!]
      \includegraphics[width=\textwidth]{stakeholders.png}
      \centering
      \caption{Stakeholdermatrix des Projekts (NW)}
      \label{fig:stakeholders}
    \end{figure}

	
	\subsection{Projektauftrag (NW)}
	...
	\subsection{Dokumentationsform (NW)}
  ...
  \begin{figure}
    ...
    \centering
    \caption{Beispielhafte Ansicht der Aufgabenverwaltung (JD)}
    \label{fig:taskmgmt}
  \end{figure}
	
	\subsection{Projekt-Canvas (NW)}
  \begin{figure}
    \includegraphics[scale=0.5]{Projektcanvas.png}
    \centering
    \caption{Projektcanvas (NW)}
    \label{fig:canvas}
  \end{figure}
