...
\begin{document}
  ...
  einteilen. Zur Auswahl eines geeigneten Modells wurde eine Gegenüberstellung der verschiedenen Optionen anhand ihrer zentralen Eigenschaften durchgeführt.
  ...
  \begin{table}
    \begin{tabular}{|p{3cm}|p{4cm}|p{4cm}|p{4cm}|}
      ...
      \hline
      \emph{Kommunikation} & Fokus auf dokumentenbasierte Kommunikation und ordentliche Meetings & kontinuierlicher Austausch durch bspw. Daily Stand Ups & 
    \end{tabular}
  \end{table}
